...
*/
const animalNames = [];
let aniNames = zooAnimals.forEach(function(zoo) {
  animalNames.push(`Name: ${zoo.animal_name}, Scientific: ${zoo.scientific_name}`);
});
...
*/
const populationTotal = zooAnimals.reduce((populationTotal, populationNum) => {
  return populationTotal + populationNum.population;
}, 0);
